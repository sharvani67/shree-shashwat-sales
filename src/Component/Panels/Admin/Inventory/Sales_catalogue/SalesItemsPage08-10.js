...
// Remove the createDefaultBatch function and replace it with:
...
// Update the handleBatchChange function to include validation
...
const handleSubmit = async (e) => {
  ...
  // ... rest of your existing submit handler code remains the same
  try {
